...
- [0x08. Recursion, introduction](https://intranet.hbtn.io/rltoken/zcM-LmeeOnLjj-nNiOpB6g)
...
Write a function that returns `1` if the input integer is a [prime number](https://intranet.hbtn.io/rltoken/uMon4hPzNyQ_WSgpnTlShw), otherwise return `0`.
