...
Write a function that searches for a value in a sorted array of integers using the [Jump search algorithm](https://intranet.hbtn.io/rltoken/4_BD4JVE3OEcj0sPnXgFFw)
